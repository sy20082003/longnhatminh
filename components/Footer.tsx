      ...
      <div className="container-px mx-auto grid max-w-7xl gap-10 py-16 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3 text-sm">
            ...
            <li>
              <Link href="/gioi-thieu" className="text-navy-300 hover:text-white">
                Giới thiệu
              </Link>
            </li>
            <li>
              <Link href="/thu-vien-anh" className="text-navy-300 hover:text-white">
                Thư viện ảnh
              </Link>
            </li>
            <li>
              <Link href="/lien-he" className="text-navy-300 hover:text-white">
                Liên hệ
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3 text-sm">
            <li>
              <Link href="/dich-vu/tram-bien-ap" className="text-navy-300 hover:text-white">
                Thiết kế & Thi công Trạm biến áp
              </Link>
            </li>
            <li>
              <Link href="/dich-vu/dien-nha-xuong" className="text-navy-300 hover:text-white">
